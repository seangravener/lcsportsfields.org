...
INSERT INTO `exp_developer_log` VALUES (22,1377041842,'n',NULL,'remove_double_slashes()',137,'C:\\xampp\\htdocs\\lcsportsfields.org\\system\\expressionengine\\third_party\\channel_images\\locations\\local\\local.php','2.6','reduce_double_slashes()',10,'.slider','home','Channel','entries',NULL),(23,1375392632,'y',NULL,'EE_Fieldtype()',56,'C:\\xampp\\htdocs\\lcsportsfields.org\\system\\expressionengine\\third_party\\nsm_publish_hints\\ft.nsm_publish_hints.php','2.6','EE_Fieldtype::__construct()',0,NULL,NULL,NULL,NULL,NULL),(24,1375392691,'y',NULL,'do_hash()',224,'C:\\xampp\\htdocs\\lcsportsfields.org\\system\\expressionengine\\third_party\\nsm_htaccess_generator\\ext.nsm_htaccess_generator.php','2.6','PHP\'s hashing functions',0,NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `exp_security_hashes` (
  ...
  PRIMARY KEY (`hash_id`),
  KEY `hash` (`hash`)
) ENGINE=MyISAM AUTO_INCREMENT=1429 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `exp_sessions` VALUES ('43b3eee390eb4cb66b7468fd009cef6ff59eedda',1,1,'127.0.0.1','Mozilla/5.0 (Windows NT 6.1; WOW64; rv:22.0) Gecko/20100101 Firefox/22.0','8e8a8705d0d0e858cd096dc345498b1f',1375392590,1375394519);
...
INSERT INTO `exp_stats` VALUES (1,1,1,1,'admin-kvq',12,0,0,0,1375392600,0,0,1368902724,1,1368900958,1377646642);
...
-- Dump completed on 2013-08-20 19:38:40
